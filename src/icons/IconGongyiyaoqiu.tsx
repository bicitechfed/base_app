...
let IconGongyiyaoqiu: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconGongyiyaoqiu.defaultProps = {
  size: 18,
};

IconGongyiyaoqiu = React.memo ? React.memo(IconGongyiyaoqiu) : IconGongyiyaoqiu;

export default IconGongyiyaoqiu;
