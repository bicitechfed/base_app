...
let IconGongyiwanchengqingkuang: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconGongyiwanchengqingkuang.defaultProps = {
  size: 18,
};

IconGongyiwanchengqingkuang = React.memo ? React.memo(IconGongyiwanchengqingkuang) : IconGongyiwanchengqingkuang;

export default IconGongyiwanchengqingkuang;
