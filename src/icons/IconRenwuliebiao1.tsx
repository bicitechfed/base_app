...
let IconRenwuliebiao1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconRenwuliebiao1.defaultProps = {
  size: 18,
};

IconRenwuliebiao1 = React.memo ? React.memo(IconRenwuliebiao1) : IconRenwuliebiao1;

export default IconRenwuliebiao1;
