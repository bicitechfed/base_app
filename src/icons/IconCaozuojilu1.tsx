...
let IconCaozuojilu1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconCaozuojilu1.defaultProps = {
  size: 18,
};

IconCaozuojilu1 = React.memo ? React.memo(IconCaozuojilu1) : IconCaozuojilu1;

export default IconCaozuojilu1;
