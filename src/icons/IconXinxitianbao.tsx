...
let IconXinxitianbao: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconXinxitianbao.defaultProps = {
  size: 18,
};

IconXinxitianbao = React.memo ? React.memo(IconXinxitianbao) : IconXinxitianbao;

export default IconXinxitianbao;
