...
let IconCloudDownload: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      />
      <Path
        d="M627.008 723.2l-82.816 82.496V511.808H480.128v293.888l-82.816-82.56-45.312 45.248 137.6 137.088a32 32 0 0 0 45.12 0l137.6-137.088-45.312-45.184z"
